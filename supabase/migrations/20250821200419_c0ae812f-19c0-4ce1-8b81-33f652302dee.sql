...
DROP POLICY "Verified users can create reactions" ON public.reactions;
...
DROP POLICY "Verified users can create comments" ON public.comments;
...
DROP POLICY "Verified users can create stories" ON public.stories;
