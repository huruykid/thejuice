...
-- 2. Create RLS policies for verification-selfies bucket
-- Users can upload, view, update and delete their own verification selfies
...
-- 3. Create RLS policies for story-images bucket (if not already present)
-- Users can upload to their own folders, anyone can view (since stories are public)
...
-- 4. Create audit logging for sensitive file access
